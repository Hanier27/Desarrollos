...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-04-2018 a las 01:32:01
...
(46, 'Segunda Lista', '2018-04-27', 7),
(48, 'Tercera Lista', '2018-04-27', 10);
...
--
ALTER TABLE `tbl_listas`
  MODIFY `codigo_lista` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;

--
-- AUTO_INCREMENT de la tabla `tbl_tarjetas`
--
ALTER TABLE `tbl_tarjetas`
  MODIFY `codigo_tarjeta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
